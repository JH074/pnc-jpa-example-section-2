...
public class VacationController {
    ...
    public ResponseEntity<GeneralResponse> getAllVacations() {
        ...
        if (vacations.isEmpty()) {
            throw new DepartmentNotFoundException("Vacations were not found");
        }
    ...
    public ResponseEntity<GeneralResponse> getVacationById(@PathVariable int id) {
        ...
        if (vacation == null) {
            throw new VacationNotFoundException("Vacation not found with ID: " + id);
        }
    ...
    @PostMapping()
    public ResponseEntity<GeneralResponse> saveVacation(@Valid @RequestBody VacationRequest vacation) {
